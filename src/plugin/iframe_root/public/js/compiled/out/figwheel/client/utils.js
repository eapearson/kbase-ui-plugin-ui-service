...
return (new CustomEvent(event_name,(function (){var obj41800 = {"detail":data};
return obj41800;
})()));
} else {
...
var f = (function (){var pred__41807 = cljs.core._EQ_;
var expr__41808 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__41807.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__41808))){
return ((function (pred__41807,expr__41808){
return (function (p1__41801_SHARP_){
return console.warn(p1__41801_SHARP_);
});
;})(pred__41807,expr__41808))
} else {
if(cljs.core.truth_(pred__41807.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__41808))){
return ((function (pred__41807,expr__41808){
return (function (p1__41802_SHARP_){
return console.debug(p1__41802_SHARP_);
});
;})(pred__41807,expr__41808))
} else {
if(cljs.core.truth_(pred__41807.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__41808))){
return ((function (pred__41807,expr__41808){
return (function (p1__41803_SHARP_){
return console.error(p1__41803_SHARP_);
});
;})(pred__41807,expr__41808))
} else {
return ((function (pred__41807,expr__41808){
return (function (p1__41804_SHARP_){
return console.log(p1__41804_SHARP_);
});
;})(pred__41807,expr__41808))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__41811){
...
var opts = map__41812__$1;
var eval_fn = cljs.core.get.call(null,map__41812__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__41814_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__41816,(0),null);
var v = cljs.core.nth.call(null,vec__41816,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1523222484354
