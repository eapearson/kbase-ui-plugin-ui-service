...
var or__30194__auto__ = goog.object.get(goog.global,"FIGWHEEL_WEBSOCKET_CLASS");
if(cljs.core.truth_(or__30194__auto__)){
return or__30194__auto__;
} else {
var or__30194__auto____$1 = goog.object.get(goog.global,"WebSocket");
...
}catch (e43752){if((e43752 instanceof Error)){
var e = e43752;
return null;
} else {
throw e43752;
...
var and__30182__auto__ = cljs.core.map_QMARK_.call(null,msg);
if(and__30182__auto__){
var and__30182__auto____$1 = new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg);
if(cljs.core.truth_(and__30182__auto____$1)){
var and__30182__auto____$2 = cljs.core.not_EQ_.call(null,new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg),new cljs.core.Keyword(null,"ping","ping",-1670114784));
...
figwheel.client.socket.open = (function figwheel$client$socket$open(p__43753){
...
var opts = map__43754__$1;
var retry_count = cljs.core.get.call(null,map__43754__$1,new cljs.core.Keyword(null,"retry-count","retry-count",1936122875));
var retried_count = cljs.core.get.call(null,map__43754__$1,new cljs.core.Keyword(null,"retried-count","retried-count",-2127867357));
var websocket_url = cljs.core.get.call(null,map__43754__$1,new cljs.core.Keyword(null,"websocket-url","websocket-url",-490444938));
var build_id = cljs.core.get.call(null,map__43754__$1,new cljs.core.Keyword(null,"build-id","build-id",1642831089));
...
socket.onclose = ((function (url,socket,WebSocket,temp__5455__auto__,map__43754,map__43754__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
var retried_count__$1 = (function (){var or__30194__auto__ = retried_count;
if(cljs.core.truth_(or__30194__auto__)){
return or__30194__auto__;
} else {
return (0);
...
return setTimeout(((function (retried_count__$1,url,socket,WebSocket,temp__5455__auto__,map__43754,map__43754__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (){
...
});})(retried_count__$1,url,socket,WebSocket,temp__5455__auto__,map__43754,map__43754__$1,opts,retry_count,retried_count,websocket_url,build_id))
,(function (){var x__30553__auto__ = (10000);
var y__30554__auto__ = ((2000) + ((500) * retried_count__$1));
...
socket.onerror = ((function (url,socket,WebSocket,temp__5455__auto__,map__43754,map__43754__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
//# sourceMappingURL=socket.js.map?rel=1523222486193
