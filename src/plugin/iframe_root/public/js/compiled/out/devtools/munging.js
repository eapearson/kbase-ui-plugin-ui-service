...
var o36023 = temp__5455__auto__;
var temp__5455__auto____$1 = (o36023["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o36024 = temp__5455__auto____$1;
return (o36024["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__35104__auto__ = f;
return (o__35104__auto__["toString"]).call(o__35104__auto__);
} else {
return "";
}
}catch (e36025){var _ = e36025;
return "";
}});
...
try{var o__35104__auto___36027 = t;
(o__35104__auto___36027["cljs$lang$ctorPrWriter"]).call(o__35104__auto___36027,t,writer);
}catch (e36026){var __36028 = e36026;
}
...
var char_code = (function (){var o__35104__auto__ = (new String(char$));
return (o__35104__auto__["charCodeAt"]).call(o__35104__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__35104__auto__ = String;
return (o__35104__auto__["fromCharCode"]).call(o__35104__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__36029 = num_code;
switch (G__36029) {
case (1):
return (185);
...
var o__35104__auto__ = String;
return (o__35104__auto__["fromCharCode"]).call(o__35104__auto__,superscript_code);
});
/**
...
}catch (e36031){var _e__35111__auto__ = e36031;
return false;
}})())){
...
var vec__36032 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__36032,(0),null);
...
var or__30194__auto__ = (function (){var temp__5455__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5455__auto__)){
...
if(cljs.core.truth_(temp__5455__auto__)){
var o36035 = temp__5455__auto__;
var temp__5455__auto____$1 = (o36035["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o36036 = temp__5455__auto____$1;
return (o36036["nameToPath"]);
} else {
return null;
}
} else {
...
var len__31473__auto___36043 = arguments.length;
var i__31474__auto___36044 = (0);
while(true){
if((i__31474__auto___36044 < len__31473__auto___36043)){
args__31480__auto__.push((arguments[i__31474__auto___36044]));

var G__36045 = (i__31474__auto___36044 + (1));
i__31474__auto___36044 = G__36045;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31481__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__36039){
var vec__36040 = p__36039;
var ns_detector = cljs.core.nth.call(null,vec__36040,(0),null);
var effective_detector = (function (){var or__30194__auto__ = ns_detector;
if(cljs.core.truth_(or__30194__auto__)){
return or__30194__auto__;
} else {
...
var G__36046 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__36047 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__36046;
remaining_tokens = G__36047;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq36037){
var G__36038 = cljs.core.first.call(null,seq36037);
var seq36037__$1 = cljs.core.next.call(null,seq36037);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__36038,seq36037__$1);
});
...
var vec__36051 = cljs.core.split_with.call(null,(function (p1__36050_SHARP_){
return cljs.core.not_EQ_.call(null,p1__36050_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__36051,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__36051,(1),null);
...
var vec__36054 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__36054,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__36054,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__36057 = cljs.core.rest.call(null,remaining_tokens);
var G__36058 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__36057;
name_tokens = G__36058;
continue;
} else {
...
var vec__36061 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__36061,(0),null);
var arity = cljs.core.nth.call(null,vec__36061,(1),null);
var vec__36064 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__36064,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__36064,(1),null);
var vec__36067 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__36067,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__36067,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__36067,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__36067,(3),null);
...
var vec__36073 = result;
var munged_ns = cljs.core.nth.call(null,vec__36073,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__36073,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__36073,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__36073,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__36073,(4),null);
var arity = cljs.core.nth.call(null,vec__36073,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__36077 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__36077,(0),null);
var args = cljs.core.nth.call(null,vec__36077,(1),null);
var vec__36080 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__36080,(0),null);
var name = cljs.core.nth.call(null,vec__36080,(1),null);
...
var G__36083 = (arity + (1));
var G__36084 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__36085){
var vec__36086 = p__36085;
var arity = cljs.core.nth.call(null,vec__36086,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__36086,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__30194__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__30194__auto__)){
return or__30194__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__36089_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__36090_SHARP_);
...
var args__31480__auto__ = [];
var len__31473__auto___36097 = arguments.length;
var i__31474__auto___36098 = (0);
while(true){
if((i__31474__auto___36098 < len__31473__auto___36097)){
args__31480__auto__.push((arguments[i__31474__auto___36098]));

var G__36099 = (i__31474__auto___36098 + (1));
i__31474__auto___36098 = G__36099;
continue;
} else {
}
break;
...
var argseq__31481__auto__ = ((((1) < args__31480__auto__.length))?(new cljs.core.IndexedSeq(args__31480__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31481__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__36093){
var vec__36094 = p__36093;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__36094,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq36091){
var G__36092 = cljs.core.first.call(null,seq36091);
var seq36091__$1 = cljs.core.next.call(null,seq36091);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__36092,seq36091__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__30194__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__30194__auto__)){
return or__30194__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__30182__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__30194__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__30194__auto__)){
return or__30194__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__36102__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__36102__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__36102__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__36102__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__36103 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__36103,(0),null);
var fn_name = cljs.core.nth.call(null,vec__36103,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__36103,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__36103,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__36103,(4),null);
var arity = cljs.core.nth.call(null,vec__36103,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__30182__auto__ = protocol_ns;
if(cljs.core.truth_(and__30182__auto__)){
return cljs.core.not.call(null,(function (){var and__30182__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__30194__auto__ = protocol_part;
if(cljs.core.truth_(or__30194__auto__)){
return or__30194__auto__;
} else {
return fn_part;
...
var o__35104__auto__ = f;
return (o__35104__auto__["getBasis"]).call(o__35104__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__30182__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__30182__auto__)){
...
}catch (e36107){var _e__35111__auto__ = e36107;
...
var G__36108 = (obj[cljs.core.first.call(null,path)]);
var G__36109 = cljs.core.rest.call(null,path);
obj = G__36108;
path = G__36109;
continue;
} else {
...
var partition_bits = (function (){var or__30194__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__30194__auto__)){
return or__30194__auto__;
} else {
return (0);
...
return (function (accum,p__36110){
var vec__36111 = p__36110;
var bit = cljs.core.nth.call(null,vec__36111,(0),null);
var protocol = cljs.core.nth.call(null,vec__36111,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__36114){
var vec__36115 = p__36114;
var ns = cljs.core.nth.call(null,vec__36115,(0),null);
var name = cljs.core.nth.call(null,vec__36115,(1),null);
var selector = cljs.core.nth.call(null,vec__36115,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__36120,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__36120,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__36120,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__36118_SHARP_){
return (obj[cljs.core.first.call(null,p1__36118_SHARP_)]);
});})(name,sorted_matches,vec__36120,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1523222479000
