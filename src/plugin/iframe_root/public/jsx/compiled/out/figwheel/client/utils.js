...
var or__30194__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj41801 = {"detail":data};
return obj41801;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__30182__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__30182__auto__)){
var and__30182__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__41808 = cljs.core._EQ_;
var expr__41809 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__41808.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__41809))){
return ((function (pred__41808,expr__41809){
return (function (p1__41802_SHARP_){
return console.warn(p1__41802_SHARP_);
});
;})(pred__41808,expr__41809))
} else {
if(cljs.core.truth_(pred__41808.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__41809))){
return ((function (pred__41808,expr__41809){
return (function (p1__41803_SHARP_){
return console.debug(p1__41803_SHARP_);
});
;})(pred__41808,expr__41809))
} else {
if(cljs.core.truth_(pred__41808.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__41809))){
return ((function (pred__41808,expr__41809){
return (function (p1__41804_SHARP_){
return console.error(p1__41804_SHARP_);
});
;})(pred__41808,expr__41809))
} else {
return ((function (pred__41808,expr__41809){
return (function (p1__41805_SHARP_){
return console.log(p1__41805_SHARP_);
});
;})(pred__41808,expr__41809))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__41812){
...
var eval_fn = cljs.core.get.call(null,map__41813__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__41815_SHARP_);
});})(new_def))
);
...
return (function (p__41816){
var vec__41817 = p__41816;
var ky = cljs.core.nth.call(null,vec__41817,(0),null);
var v = cljs.core.nth.call(null,vec__41817,(1),null);
...
if(cljs.core.truth_((function (){var and__30182__auto__ = figwheel.client.utils.feature_QMARK_.call(null,localStorage,"getItem");
if(cljs.core.truth_(and__30182__auto__)){
...
//# sourceMappingURL=utils.js.map?rel=1521387315663
