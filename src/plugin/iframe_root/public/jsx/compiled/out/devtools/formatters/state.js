...
var len__31474__auto___36146 = arguments.length;
var i__31475__auto___36147 = (0);
while(true){
if((i__31475__auto___36147 < len__31474__auto___36146)){
args__31481__auto__.push((arguments[i__31475__auto___36147]));

var G__36148 = (i__31475__auto___36147 + (1));
i__31475__auto___36147 = G__36148;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31482__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq36144){
var G__36145 = cljs.core.first.call(null,seq36144);
var seq36144__$1 = cljs.core.next.call(null,seq36144);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__36145,seq36144__$1);
});
...
return (p1__36149_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1521387309898
