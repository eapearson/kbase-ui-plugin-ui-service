...
var o36024 = temp__5455__auto__;
var temp__5455__auto____$1 = (o36024["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o36025 = temp__5455__auto____$1;
return (o36025["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__35105__auto__ = f;
return (o__35105__auto__["toString"]).call(o__35105__auto__);
} else {
return "";
}
...
try{var o__35105__auto___36028 = t;
(o__35105__auto___36028["cljs$lang$ctorPrWriter"]).call(o__35105__auto___36028,t,writer);
}catch (e36027){var __36029 = e36027;
}
...
var char_code = (function (){var o__35105__auto__ = (new String(char$));
return (o__35105__auto__["charCodeAt"]).call(o__35105__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__35105__auto__ = String;
return (o__35105__auto__["fromCharCode"]).call(o__35105__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__36030 = num_code;
switch (G__36030) {
case (1):
return (185);
...
var o__35105__auto__ = String;
return (o__35105__auto__["fromCharCode"]).call(o__35105__auto__,superscript_code);
});
/**
...
}catch (e36032){var _e__35112__auto__ = e36032;
return false;
}})())){
...
var vec__36033 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__36033,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o36036 = temp__5455__auto__;
var temp__5455__auto____$1 = (o36036["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o36037 = temp__5455__auto____$1;
return (o36037["nameToPath"]);
} else {
return null;
}
} else {
...
var len__31474__auto___36044 = arguments.length;
var i__31475__auto___36045 = (0);
while(true){
if((i__31475__auto___36045 < len__31474__auto___36044)){
args__31481__auto__.push((arguments[i__31475__auto___36045]));

var G__36046 = (i__31475__auto___36045 + (1));
i__31475__auto___36045 = G__36046;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31482__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__36040){
var vec__36041 = p__36040;
var ns_detector = cljs.core.nth.call(null,vec__36041,(0),null);
...
var G__36047 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__36048 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__36047;
remaining_tokens = G__36048;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq36038){
var G__36039 = cljs.core.first.call(null,seq36038);
var seq36038__$1 = cljs.core.next.call(null,seq36038);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__36039,seq36038__$1);
});
...
var vec__36052 = cljs.core.split_with.call(null,(function (p1__36051_SHARP_){
return cljs.core.not_EQ_.call(null,p1__36051_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__36052,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__36052,(1),null);
...
var vec__36055 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__36055,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__36055,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__36058 = cljs.core.rest.call(null,remaining_tokens);
var G__36059 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__36058;
name_tokens = G__36059;
continue;
} else {
...
var vec__36062 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__36062,(0),null);
var arity = cljs.core.nth.call(null,vec__36062,(1),null);
var vec__36065 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__36065,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__36065,(1),null);
var vec__36068 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__36068,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__36068,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__36068,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__36068,(3),null);
...
var vec__36074 = result;
var munged_ns = cljs.core.nth.call(null,vec__36074,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__36074,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__36074,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__36074,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__36074,(4),null);
var arity = cljs.core.nth.call(null,vec__36074,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__36078 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__36078,(0),null);
var args = cljs.core.nth.call(null,vec__36078,(1),null);
var vec__36081 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__36081,(0),null);
var name = cljs.core.nth.call(null,vec__36081,(1),null);
...
var G__36084 = (arity + (1));
var G__36085 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__36086){
var vec__36087 = p__36086;
var arity = cljs.core.nth.call(null,vec__36087,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__36087,(1),null);
...
return cljs.core.get.call(null,arities,p1__36090_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__36091_SHARP_);
...
var args__31481__auto__ = [];
var len__31474__auto___36098 = arguments.length;
var i__31475__auto___36099 = (0);
while(true){
if((i__31475__auto___36099 < len__31474__auto___36098)){
args__31481__auto__.push((arguments[i__31475__auto___36099]));

var G__36100 = (i__31475__auto___36099 + (1));
i__31475__auto___36099 = G__36100;
continue;
} else {
}
break;
...
var argseq__31482__auto__ = ((((1) < args__31481__auto__.length))?(new cljs.core.IndexedSeq(args__31481__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31482__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__36094){
var vec__36095 = p__36094;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__36095,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq36092){
var G__36093 = cljs.core.first.call(null,seq36092);
var seq36092__$1 = cljs.core.next.call(null,seq36092);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__36093,seq36092__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__36103__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__36103__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__36103__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__36103__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__36104 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__36104,(0),null);
var fn_name = cljs.core.nth.call(null,vec__36104,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__36104,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__36104,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__36104,(4),null);
var arity = cljs.core.nth.call(null,vec__36104,(5),null);
...
var o__35105__auto__ = f;
return (o__35105__auto__["getBasis"]).call(o__35105__auto__);
});
/**
...
}catch (e36108){var _e__35112__auto__ = e36108;
...
var G__36109 = (obj[cljs.core.first.call(null,path)]);
var G__36110 = cljs.core.rest.call(null,path);
obj = G__36109;
path = G__36110;
continue;
} else {
...
return (function (accum,p__36111){
var vec__36112 = p__36111;
var bit = cljs.core.nth.call(null,vec__36112,(0),null);
var protocol = cljs.core.nth.call(null,vec__36112,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__36115){
var vec__36116 = p__36115;
var ns = cljs.core.nth.call(null,vec__36116,(0),null);
var name = cljs.core.nth.call(null,vec__36116,(1),null);
var selector = cljs.core.nth.call(null,vec__36116,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__36121,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__36121,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__36121,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__36119_SHARP_){
return (obj[cljs.core.first.call(null,p1__36119_SHARP_)]);
});})(name,sorted_matches,vec__36121,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1521387309777
