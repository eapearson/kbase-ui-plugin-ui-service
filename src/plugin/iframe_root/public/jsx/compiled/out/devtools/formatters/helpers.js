...
var G__36126 = devtools.prefs.pref.call(null,v);
v = G__36126;
continue;
} else {
return v;
...
}catch (e36129){var _e__35112__auto__ = e36129;
return false;
}})();
...
}catch (e36133){var _e__35112__auto__ = e36133;
return false;
}})();
...
}catch (e36135){var _e__35112__auto__ = e36135;
return false;
}}
}
});
...
var vec__36137 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__36137,(0),null);
var name = cljs.core.nth.call(null,vec__36137,(1),null);
...
return cljs.core.some.call(null,(function (p1__36140_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__36140_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1521387309865
