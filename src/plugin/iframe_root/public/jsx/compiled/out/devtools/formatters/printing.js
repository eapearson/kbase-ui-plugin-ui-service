...
var len__31474__auto___36155 = arguments.length;
var i__31475__auto___36156 = (0);
while(true){
if((i__31475__auto___36156 < len__31474__auto___36155)){
args__31481__auto__.push((arguments[i__31475__auto___36156]));

var G__36157 = (i__31475__auto___36156 + (1));
i__31475__auto___36156 = G__36157;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__31482__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq36152){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__36153,G__36154,seq36152__$2);
});
...
if(cljs.core.truth_((function (){var or__30194__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__30866__auto__,writer__30867__auto__,opt__30868__auto__){
return cljs.core._write.call(null,writer__30867__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__30182__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__30182__auto__){
var or__30194__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__30194__auto__)){
return or__30194__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__36158_SHARP_){
return !((cljs.core.meta.call(null,p1__36158_SHARP_) == null));
})))){
...
var map__36159 = opts;
var map__36159__$1 = ((((!((map__36159 == null)))?((((map__36159.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__36159.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__36159):map__36159);
var markup_db = cljs.core.get.call(null,map__36159__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__30194__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e36163){var _e__35112__auto__ = e36163;
return false;
}})();
if(cljs.core.truth_(or__30194__auto__)){
return or__30194__auto__;
...
}catch (e36165){var _e__35112__auto__ = e36165;
return false;
}}
})())){
...
var _STAR_current_state_STAR_36167 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__36168 = opts;
var map__36168__$1 = ((((!((map__36168 == null)))?((((map__36168.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__36168.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__36168):map__36168);
var markup_db = cljs.core.get.call(null,map__36168__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_36167;
}});
...
;
var temp__5455__auto___36172 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___36172)){
var managed_print_level_36173 = temp__5455__auto___36172;
var _STAR_print_level_STAR_36171_36174 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_36173;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_36171_36174,managed_print_level_36173,temp__5455__auto___36172,writer,opts,job_fn){
return (function (p1__36170_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__36170_SHARP_,null);
});})(_STAR_print_level_STAR_36171_36174,managed_print_level_36173,temp__5455__auto___36172,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_36171_36174;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1521387309964
